            ...
            <div class="pad_10">
                ...
                >
                    ...
                    <div class="con" style="display: flex;width: 50%">
                        ...
                        <div style="display: inline-block;">{{this.isConfirm}}</div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style="display: inline-block;width: 50%">
                        <div style="display: inline-block;width:120px">出入类型：</div>
                        <div
                ...
                >
                    ...
                    <div style="display: inline-block;width: 50%">
                        <div style="display: inline-block;width:120px">审核日期：</div>
                        <div
                                style="display: inline-block;"
                        >{{this.verifyDate}}
                        </div>
            ...
            <div style="margin-top: 40px">
                ...
                >
                    <div style="display: inline-block;width: 25%">
                        <div style="display: inline-block;">制单/入库：</div>
        ...
        methods: {
            getSummaries(param) {
                ...
                columns.forEach((column, index) => {
                    ...
                    if (column.property == 'productID' || column.property == 'inAmount' || column.property == 'maxPrice' || column.property == 'price') {
                        sums[index] = "";
                        return
                    }
