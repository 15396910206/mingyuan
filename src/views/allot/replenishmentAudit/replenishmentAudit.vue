        ...
        methods: {
            ...
            getSummaries(param) {
                ...
                columns.forEach((column, index) => {
                    ...
                    if (column.property == 'productID' || column.property == 'Specification' || column.property == 'inAmount' || column.property == 'maxPrice' || column.property == 'price') {
                        sums[index] = "";
                        return
                    }
