<template>
    <div v-loading="loading">
        ...
        <!--打印显示的东西-->
        <div class="none" id="printContent">
            <div class="pad_10 marlt_20">
                <div
                ...
                >
                    ...
                    <div style="display: inline-block;width: 50%">
                        ...
                        <div style="display: inline-block; padding-right: 20px;">{{this.billDate}}</div>
                    </div>
                </div>
                ...
                >
                    <div class="con" style="display: inline-block;width: 50%">
                        <div style="display: inline-block;width: 120px;">客户商：</div>
                        <div style="display: inline-block;">{{this.clientName}}</div>
                    </div>
                    <div class="con" style="display: flex;width: 50%">
                        <div style="display: inline-block;width: 120px;">供应商</div>
                        <div style="display: inline-block;">{{this.custName}}</div>
                    </div>
                </div>
                ...
                >
                    <div class="con" style="display: inline-block;width: 50%">
                        ...
                        <div style="display: inline-block;">{{this.stockDest}}</div>
                    </div>
                    <div class="con" style="display: flex;width: 50%">
                ...
                >
                    <div style="display: inline-block;width: 50%">
                        ...
                        <div style="display: inline-block;padding-right: 20px;">{{this.accountName}}</div>
                    </div>
                    <div style="display: inline-block;width: 50%">
                ...
                >
                    <div style="display: inline-block;width: 50%">
                        ...
                        <div style="display: inline-block;">{{this.entityName}}</div>
                    </div>
                    <div style="display: inline-block;width: 50%">
