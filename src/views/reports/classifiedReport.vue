            ...
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="月结批次">
                <el-select v-model="settleValue" placeholder="请选择" clearable size="mini">
                  <el-option v-for="item in settleList" :key="item" :label="item" :value="item"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="货品">
                <el-input type="text" v-model="name" placeholder="请输入名称或编号" clearable size="mini"></el-input>
              </el-form-item>
      ...
      <div style="width:100%;over-flow-x:auto;">
        ...
        >
          ...
          <el-table-column label="期初库存" align="center">
            <el-table-column prop="inAmount1" label="数量" align="center"></el-table-column>
            <el-table-column prop="oldPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="oneNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="采购入库" align="center">
            <el-table-column prop="inAmount2" label="数量" align="center"></el-table-column>
            <el-table-column prop="inPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="twoNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="采购退货" align="center">
            <el-table-column prop="inAmount3" label="数量" align="center"></el-table-column>
            <el-table-column prop="inPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="threeNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="盘点入库" align="center">
            <el-table-column prop="inAmount4" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="fourNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="盘点出库" align="center">
            <el-table-column prop="inAmount5" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="fiveNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="调拨入库" align="center">
            <el-table-column prop="inAmount6" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="sixNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="调拨出库" align="center">
            <el-table-column prop="inAmount7" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="sevenNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="销售出库" align="center">
            <el-table-column prop="inAmount8" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="eightNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="销售退货" align="center">
            <el-table-column prop="inAmount9" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="nineNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="消耗出库" align="center">
            <el-table-column prop="inAmount10" label="数量" align="center"></el-table-column>
            <el-table-column prop="outPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="tenNum" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="期末库存" align="center">
            <el-table-column prop="Balance" label="数量" align="center"></el-table-column>
            <el-table-column prop="BPrice" label="单价（元）" align="center"></el-table-column>
            <el-table-column prop="Total" label="金额（元）" align="center"></el-table-column>
          </el-table-column>
        </el-table>
